...
@interface BRWebSocket : NSObject <NSStreamDelegate>
...
- (void)webSocket:(BRWebSocket *)webSocket didCloseWithCode:(NSInteger)code reason:(NSString *)reason wasClean:(BOOL)wasClean;
